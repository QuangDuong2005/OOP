...
public class TourCtrl {
    ...
    // Tạo tour mới
    public void createTour(String ID,String description, String departurePoint, double pricePerPerson, int maxPeople, String startDate, String endDate) throws InvalidDateException, DuplicateException {
        for (Tour tour: tours){
