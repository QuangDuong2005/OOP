...
public class Customer extends Person {
    ...
    public Customer(String fullName, String dobString, String phoneNumber, String email) {
        super(fullName, dobString, phoneNumber);
        this.email = email;
        this.customerID = "C" + String.format("%03d", ++numberCustomers); // Tạo customerID tự động theo định dạng C001, C002, ...
        this.createdAt = LocalDate.now();
    }

    // Constructor khi không có email
    public Customer(String fullName, String dobString, String phoneNumber) {
        super(fullName, dobString, phoneNumber);
